...
const BlogPostsList = () => {
  ...
  const fetchBlogPosts = useCallback(() => {
    axios.get(`http://localhost:5000/api/getBlogPosts?page=${currentPage}`) // currentPage
      .then((response) => {
  ...
  const renderPagination = () => {
    ...
    console.log('Iteracja w renderPagination, pages:', pages);
    console.log('IF w handlePageChange, totalPages:', totalPages);
    return pages;
  };
